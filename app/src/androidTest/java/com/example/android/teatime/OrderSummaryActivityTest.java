...
public class OrderSummaryActivityTest {
    ...
    @Rule
    public IntentsTestRule<OrderSummaryActivity> mOrderSummaryTestRule = new IntentsTestRule<>(OrderSummaryActivity.class);
    private String message = "I just ordered a delicious tea from TeaTime. Next time you are craving a tea, check them out!";
